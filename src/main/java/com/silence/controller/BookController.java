...
public class BookController {
    ...
    public R getBookPage(@PathVariable int pageNumber, @PathVariable int pageSize, BookDO bookDO) {
        return new R(true, bookService.getBookPage(pageNumber, pageSize, bookDO));
    }
}
